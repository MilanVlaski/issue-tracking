...
public class ProblemPages {
    ...
    public ProblemPages(CurrentUser currentLogin, ProblemProcessing problemProcessing,
	...
	model.addAttribute("problemStates", Arrays.stream(ProblemState.values()).map(ProblemState::getEnglish));
	return "answerProblem";
    }

    @PostMapping("/engineer/problems/{problemId}/answer")
    public String answerProblemPost(@PathVariable String problemId, @ModelAttribute AnswerDto answer,
	    HttpServletRequest request, RedirectAttributes redirectAttributes) {
	var problem = em.find(Problem.class, problemId);
	problemProcessing.answerProblem(problem, answer.toEntity(), currentLogin.engineer(),
    ...
    public String assignEngineer(@PathVariable String problemId, HttpServletRequest request) {
    ...
    public String uploadPatch(@PathVariable String problemId, @ModelAttribute PatchUpload patchUpload,
	    HttpServletRequest request, RedirectAttributes redirectAttributes) {

	var problem = em.find(Problem.class, problemId);
	var newApp = problemProcessing.patchProblem(problem, patchUpload.toEntity(), currentLogin.engineer());
